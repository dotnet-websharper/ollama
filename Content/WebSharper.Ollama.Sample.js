...
import { Lazy, MarkResizable, SetOptional, Force, GetOptional, CreateFuncWithArgs, DeleteEmptyFields, Create as Create_2, OnLoad } from "./WebSharper.Core.JavaScript/Runtime.js"
import { Ollama as Ollama_1 } from "ollama/browser"
function isIDisposable(x){
  return"Dispose"in x;
}
function Main(){
  const newName=_c_1.Create_1("");
  const L=_c_14.Convert((name) => {
    const this_4=new _c_3("New_1");
    const b_1=(this_4.h.push(new _c_8("name", name)),this_4);
    const p_1=CompleteHoles(b_1.k, b_1.h, []);
    const i_1=new _c_2(p_1[1], listitem(p_1[0]));
    let _3=(b_1.i=i_1,i_1);
    return _3.Doc;
  }, People().v);
  const this_1=new _c_3("New_1");
  const this_2=(this_1.h.push(new _c_12("listcontainer", L)),this_1);
  const t=(this_2.h.push(new _c_11("name", newName)),this_2);
  const t_1=(t.h.push(EventQ2(t.k, "add", () => t.i, () => {
    People().Append(newName.Get());
    newName.Set("");
  })),t);
  const t_2=(t_1.h.push(EventQ2(t_1.k, "generate", () => t_1.i, () => {
    const _3=null;
    Start(Delay(() => AsAsync(GenerateTest().then((response) => {
      const _4=(s) => {
        console.log(s);
      };
      const _5=response.response;
      return _4("Response: "+String(_5));
    }))), null);
  })),t_1);
  const this_3=(t_2.h.push(EventQ2(t_2.k, "chat", () => t_2.i, () => {
    const _3=null;
    Start(Delay(() => AsAsync(ChatTest().then((response) => {
      _c_1.Set(ChatResponse(), response.message.content);
      const _4=response.message.content;
      const _5=(s) => {
        console.log(s);
      };
      return _5("Response: "+String(_4));
    }))), null);
  })),t_2);
  const b=(this_3.h.push(new _c_9("chatresponse", ChatResponse().View)),this_3);
  const p=CompleteHoles(b.k, b.h, [["name", 0, null]]);
  const i=new _c_2(p[1], main(p[0]));
  let _1=(b.i=i,i);
  const _2=_1.Doc;
  LoadLocalTemplates("");
  _c_14.RunById("main", _2);
}
function ChatResponse(){
  return _c_10.ChatResponse;
}
function People(){
  return _c_10.People;
}
function GenerateTest(){
  ...
  return new Promise((_2) => {
    _2(Ollama().generate({model:"llama3.1", prompt:"Why is the sky blue?"}).then((d) => Promise.resolve(d)));
  });
}
function ChatTest(){
  const _1=null;
  return new Promise((_2) => {
    let r;
    const request=(r={model:"llama3.1"},r.messages=[{role:"user", content:"Why is the sky blue?"}],r);
    let _3=Ollama().chat(request).then((d) => Promise.resolve(d));
    _2(_3);
  });
}
function Ollama(){
...
let _c_1=Lazy((_i) => class Var extends _c {
  ...
  static Create_1(v){
    return new _c_7(false, {s:Ready(v, [])}, v);
  }
...
let _c_6=Lazy((_i) => class ListModel extends _c {
  static {
    _c_6=_i(this);
  }
  key;
...
function EventQ2(_1, holeName, ti, f){
  return new _c_13(holeName, (el) =>(ev) => {
    const i=ti();
    i.SetAnchorRoot(el);
    return f({
      Vars:i, 
...
function CompleteHoles(key, filledHoles, vars){
  const allVars=new _c_15("New_5");
  const filledVars=new _c_17("New_3");
  ...
  return[append(filledHoles, choose((_1) => {
    ...
    if(filledVars.Contains(name))return null;
      ...
      const r=ty===0?_c_18.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_1.Create_1(o==null?"":o.$0);
        return new _c_11(name, _2);
      }):ty===1?_c_18.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_1.Create_1(o==null?0:o.$0);
        return new _c_19(name, _2);
      }):ty===2?_c_18.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_1.Create_1(o==null?false:o.$0);
        return new _c_20(name, _2);
      }):ty===3?_c_18.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_1.Create_1(o==null?-8640000000000000:o.$0);
        return new _c_21(name, _2);
      }):ty===4?_c_18.GetOrAddHoleFor(key, name, () => new _c_22(name, _c_1.Create_1([]))):ty===5?_c_18.GetOrAddHoleFor(key, name, () => new _c_23(name, _c_1.Create_1(Some(globalThis.document.querySelector("[ws-dom="+name+"]"))))):ty===6?_c_18.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_1.Create_1(o==null?[]:o.$0);
        return new _c_24(name, _2);
...
let _c_10=Lazy((_i) => class $StartupCode_Client {
  static {
    _c_10=_i(this);
  }
  static Ollama;
  ...
  static ChatResponse;
  static {
    this.ChatResponse=_c_1.Create_1("");
    this.People=FromSeq(["John", "Paul"]);
    this.Ollama=new Ollama_1({host:"http://localhost:5555"});
  }
});
let _c_11=Lazy((_i) => {
  Force(_c_4);
...
function unwrapExn(x){
  return x instanceof Error?x:new _c_27(x);
}
...
function NamedTemplate(baseName, name, fillWith){
  ...
  return m[0]?ChildrenTemplate(m[1].cloneNode(true), fillWith):(console.warn("Local template doesn't exist", name),_c_14.Empty);
}
function LocalTemplatesLoaded(){
  return _c_30.LocalTemplatesLoaded;
}
function set_LocalTemplatesLoaded(_1){
  _c_30.LocalTemplatesLoaded=_1;
}
function LoadNestedTemplates(root, baseName){
  ...
  const instantiated=new _c_17("New_3");
...
function ChildrenTemplate(el, fillWith){
  ...
  return!Equals(m, null)&&m.length===1&&(get(m, 0)instanceof Node&&(Equals(get(m, 0).nodeType, Node.ELEMENT_NODE)&&(_1=get(m, 0),true)))?_c_33.TreeNode(docTreeNode, updates):_c_14.Mk(TreeDoc(docTreeNode), updates);
}
...
function PrepareTemplateStrict(baseName, name, fakeroot, prepareLocalTemplate){
  const processedHTML5Templates=new _c_17("New_3");
        ...
        case 1:
          ...
          if(instBaseName!=""&&!LoadedTemplates().ContainsKey(instBaseName))return failNotLoaded(instName);
            ...
            if(!d.ContainsKey(instName))return failNotLoaded(instName);
              ...
              const usedHoles=new _c_17("New_3");
...
function InlineTemplate(el, fillWith){
  ...
  const tryGetAsDoc=(name) => {
    ...
    if(m[0]){
      const th=m[1];
      if(th instanceof _c_12)return Some(th.Value);
      else if(th instanceof _c_8)return Some(_c_14.TextNode(th.Value));
      else {
        const o_1=th.ForTextView();
        return o_1==null?null:Some(_c_14.TextView(o_1.$0));
      }
    }
    else return null;
  };
  ...
  foreachNotPreserved(el, "[ws-on]", (e_1) => {
    addAttr(e_1, _c_40.Concat(choose((x_1) => {
      ...
      if(m[0]){
        const th=m[1];
        return th instanceof _c_39?Some(Handler(get(a, 0), th.Value)):th instanceof _c_13?Some(_c_40.Handler(get(a, 0), th.Value)):(console.warn("Event hole on"+get(a, 0)+" filled with non-event data", get(a, 1)),null);
      }
      else return null;
...
let _c_14=Lazy((_i) => class Doc extends _c {
  static {
    _c_14=_i(this);
  }
  docNode;
  ...
  static Convert(render, view){
    return _c_14.Flatten(MapSeqCached(render, view));
  }
  static Run(parent, doc){
    LinkElement(parent, doc.docNode);
    _c_14.RunInPlace(false, parent, doc);
  }
  static Flatten(view){
    return _c_14.EmbedView(Map_1(_c_14.Concat, view));
  }
  static get Empty(){
    return _c_14.Mk(null, Const());
  }
  ...
  static Concat(xs){
    return TreeReduce(_c_14.Empty, _c_14.Append, ofSeqNonCopying(xs));
  }
  static EmbedView(view){
    const node=CreateEmbedNode();
    return _c_14.Mk(EmbedDoc(node), Map_1(() => { }, Bind_1((doc) => {
  ...
  static Append(a, b){
    return _c_14.Mk(AppendDoc(a.docNode, b.docNode), Map2Unit_1(a.updates, b.updates));
  }
  static TextNode(v){
    return _c_14.Mk(TextNodeDoc(globalThis.document.createTextNode(v)), Const());
  }
  static TextView(txt){
    const node=CreateTextNode();
    return _c_14.Mk(TextDoc(node), Map_1((t) => {
...
let _c_15=Lazy((_i) => class Dictionary extends _c {
  static {
    _c_15=_i(this);
  }
  equals;
...
function CreateWithStorage(key, storage){
  return new _c_6("New", key, storage);
}
let _c_16=Lazy((_i) => class View {
  static {
    _c_16=_i(this);
  }
});
...
let _c_17=Lazy((_i) => class HashSet extends _c {
  static {
    _c_17=_i(this);
  }
  equals;
  ...
  IntersectWith(xs){
    const other=new _c_17("New_4", xs, this.equals, this.hash);
...
function distinctBy(f, s){
  return{GetEnumerator:() => {
    const o=Get(s);
    const seen=new _c_17("New_3");
    return new _c_26(null, null, (e) => {
      let cur;
      let has;
      if(o.MoveNext()){
        cur=o.Current;
...
function map(f, s){
  return{GetEnumerator:() => {
    const en=Get(s);
    return new _c_26(null, null, (e) => en.MoveNext()&&(e.c=f(en.Current),true), () => {
      en.Dispose();
    });
  }};
}
...
function concat(ss){
  return{GetEnumerator:() => {
    ...
    return new _c_26(null, null, next, (st) => {
      const x=st.s;
...
function initInfinite(f){
  return{GetEnumerator:() => new _c_26(0, null, (e) => {
    e.c=f(e.s);
    e.s=e.s+1;
    return true;
  }, void 0)};
...
let _c_18=Lazy((_i) => class TemplateInitializer extends _c {
  static {
    _c_18=_i(this);
  }
  static init;
  ...
  static GetHolesFor(id){
    let o;
    const m=(o=null,[_c_18.initialized.TryGetValue(id, {get:() => o, set:(v) => {
      o=v;
    }}), o]);
    if(m[0])return m[1];
    else {
      const d=new _c_15("New_5");
      _c_18.initialized.set_Item(id, d);
      return d;
    }
  }
  static {
    _c_18.initialized=new _c_15("New_5");
    _c_18.instances=new _c_15("New_5");
  }
});
let _c_19=Lazy((_i) => {
  Force(_c_4);
...
let _c_25=Lazy((_i) => class Exception extends _c {
  static {
    _c_25=_i(this);
  }
});
...
let _c_26=Lazy((_i) => class T extends _c {
  static {
    _c_26=_i(this);
  }
  s;
...
let _c_28=Lazy((_i) => class $StartupCode_Concurrency {
  static {
    _c_28=_i(this);
  }
  static GetCT;
  ...
  static {
    ...
    this.scheduler=new _c_29();
    this.defCTS=[new _c_35()];
    this.Zero=Return();
    this.GetCT=(c) => {
      c.k(Ok(c.ct));
    };
...
let _c_29=Lazy((_i) => class Scheduler extends _c {
  static {
    _c_29=_i(this);
  }
  idle;
...
let _c_31=Lazy((_i) => class $StartupCode_Abbrev {
  static {
    _c_31=_i(this);
  }
  static counter;
...
function InMemory(init_2){
  return new _c_37(init_2);
}
let _c_33=Lazy((_i) => {
  Force(_c_14);
  return class Elt extends _c_14 {
    static {
      _c_33=_i(this);
    }
    docNode_1;
...
let _c_35=Lazy((_i) => class CancellationTokenSource extends _c {
  static {
    _c_35=_i(this);
  }
  init;
...
let _c_37=Lazy((_i) => class ArrayStorage extends _c {
  static {
    _c_37=_i(this);
  }
  init;
...
let _c_43=Lazy((_i) => class FSharpList {
  ...
  static Empty=Create_2(_c_43, {$:0});
  GetEnumerator(){
    return new _c_26(this, null, (e) => {
      const m=e.s;
...
function get_Empty_1(){
  return NodeSet(new _c_17("New_3"));
}
function FindAll(doc){
  ...
  loop(doc);
  return NodeSet(new _c_17("New_2", q));
}
...
function Filter_1(ok, set_1){
  return new _c_17("New_2", filter(ok, ToArray_2(set_1)));
}
function Except_1(excluded, included){
  const set_1=new _c_17("New_2", ToArray_2(included));
...
function Intersect_1(a, b){
  const set_1=new _c_17("New_2", ToArray_2(a));
